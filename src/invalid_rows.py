...
if __name__ == "__main__":
    try:
        ...
        print("  0. Exit")
        while True:
            gi03_val = input("Enter gi03 value from above (or 0 to exit): ").strip()
            if gi03_val == "0" or gi03_val.lower() == "exit":
                print("Exiting.")
                sys.exit(0)
        ...
        invalid_row_numbers = [int(n) for n in re.findall(r"line: '?(+)", rec_input)]
